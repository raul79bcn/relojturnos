...
function precargarTurnos(){
  if(localActivoId === 1){
    turnosConfig=[
      ...
      {id:'manana2',    nome:'Mañana 2',  emoji:'🌤', ini:'08:30',fin:'17:30',badge:'badge-manana2',   color:'#58d68d',active:true},
      {id:'tarde',      nome:'Tarde',     emoji:'🌅', ini:'15:00',fin:'00:00',badge:'badge-tarde',     color:'#e67e22',active:true},
      {id:'tarde2',     nome:'Tarde 2',   emoji:'🌆', ini:'16:00',fin:'01:00',badge:'badge-tarde2',    color:'#ff9040',active:true},
      {id:'noche',      nome:'Noche',     emoji:'🌙', ini:'18:00',fin:'03:00',badge:'badge-noche',     color:'#3498db',active:true},
      {id:'noche2',     nome:'Noche 2',   emoji:'🌃', ini:'19:00',fin:'04:00',badge:'badge-noche2',    color:'#1a78c2',active:true},
      {id:'intermedio', nome:'Intermedio',emoji:'🔄', ini:'12:00',fin:'21:00',badge:'badge-intermedio',color:'#9b59b6',active:true},
      {id:'intermedio2',nome:'Intermedio 2',emoji:'🔁',ini:'13:00',fin:'22:00',badge:'badge-intermedio2',color:'#a070e0',active:true},
      {id:'seguido1',   nome:'Seguido 1', emoji:'⏩', ini:'09:00',fin:'18:00',badge:'badge-seguido1',  color:'#20b0a0',active:true},
      {id:'seguido2',   nome:'Seguido 2', emoji:'⏭', ini:'10:00',fin:'19:00',badge:'badge-seguido2',  color:'#10c080',active:true},
      {id:'seguido3',   nome:'Seguido 3', emoji:'⏫', ini:'11:00',fin:'20:00',badge:'badge-seguido3',  color:'#00d4b0',active:true},
      {id:'intermedio3',nome:'Intermedio 3',emoji:'🔃',ini:'14:00',fin:'23:00',badge:'badge-intermedio3',color:'#8050d0',active:true},
    ...
    turnosConfig=[
      ...
      {id:'manana2',    nome:'Mañana 2',  emoji:'🌤', ini:'12:00',fin:'20:00',badge:'badge-manana2',   color:'#58d68d',active:true},
      {id:'tarde',      nome:'Tarde',     emoji:'🌅', ini:'14:00',fin:'23:00',badge:'badge-tarde',     color:'#e67e22',active:true},
      {id:'tarde2',     nome:'Tarde 2',   emoji:'🌆', ini:'15:00',fin:'00:00',badge:'badge-tarde2',    color:'#ff9040',active:true},
      {id:'noche',      nome:'Noche',     emoji:'🌙', ini:'16:00',fin:'00:00',badge:'badge-noche',     color:'#3498db',active:true},
      {id:'noche2',     nome:'Noche 2',   emoji:'🌃', ini:'17:00',fin:'01:00',badge:'badge-noche2',    color:'#1a78c2',active:true},
      {id:'intermedio', nome:'Intermedio',emoji:'🔄', ini:'12:00',fin:'20:00',badge:'badge-intermedio',color:'#9b59b6',active:true},
      {id:'seguido1',   nome:'Seguido 1', emoji:'⏩', ini:'11:00',fin:'19:00',badge:'badge-seguido1',  color:'#20b0a0',active:true},
      {id:'seguido2',   nome:'Seguido 2', emoji:'⏭', ini:'12:00',fin:'20:00',badge:'badge-seguido2',  color:'#10c080',active:true},
      {id:'seguido3',   nome:'Seguido 3', emoji:'⏫', ini:'13:00',fin:'21:00',badge:'badge-seguido3',  color:'#00d4b0',active:true},
      {id:'intermedio2',nome:'Intermedio 2',emoji:'🔁',ini:'13:00',fin:'21:00',badge:'badge-intermedio2',color:'#a070e0',active:true},
      {id:'intermedio3',nome:'Intermedio 3',emoji:'🔃',ini:'14:00',fin:'22:00',badge:'badge-intermedio3',color:'#8050d0',active:true},
...
function buildTurnosConfig(){
  ...
  if(local==='La Cala'){
    ...
    turnosConfig=[
      ...
      {id:'manana2',   nome:'Ma\u00f1ana 2', emoji:'\ud83c\udf24', ini:ap,   fin:mid1,badge:'badge-manana2',   color:'#58d68d',active:true},
      {id:'tarde',     nome:'Tarde',    emoji:'\ud83c\udf05', ini:mid1, fin:mid2,badge:'badge-tarde',     color:'#e67e22',active:true},
      {id:'tarde2',    nome:'Tarde 2',  emoji:'\ud83c\udf06', ini:mid1, fin:mid2,badge:'badge-tarde2',    color:'#ff9040',active:true},
      {id:'noche',     nome:'Noche',    emoji:'\ud83c\udf19', ini:mid2, fin:ci,  badge:'badge-noche',     color:'#3498db',active:true},
      {id:'noche2',    nome:'Noche 2',  emoji:'\ud83c\udf03', ini:mid2, fin:ci,  badge:'badge-noche2',    color:'#1a78c2',active:true},
      {id:'intermedio',  nome:'Intermedio',   emoji:'\ud83d\udd04', ini:iS,  fin:iE,badge:'badge-intermedio', color:'#9b59b6',active:true},
      {id:'intermedio2', nome:'Intermedio 2', emoji:'\ud83d\udd01', ini:iS,  fin:iE,badge:'badge-intermedio2',color:'#a070e0',active:true},
      {id:'intermedio3', nome:'Intermedio 3', emoji:'\ud83d\udd03', ini:iS,  fin:iE,badge:'badge-intermedio3',color:'#8050d0',active:true},
      {id:'seguido1',    nome:'Seguido 1',    emoji:'\u23e9', ini:ap,  fin:mid2,badge:'badge-seguido1',  color:'#20b0a0',active:true},
      {id:'seguido2',    nome:'Seguido 2',    emoji:'\u23ed', ini:mid1,fin:ci,  badge:'badge-seguido2',  color:'#10c080',active:true},
      {id:'seguido3',    nome:'Seguido 3',    emoji:'\u23eb', ini:ap,  fin:ci,  badge:'badge-seguido3',  color:'#00d4b0',active:true},
      {id:'partido',     nome:'Partido',      emoji:'\u2702\ufe0f', ini:ap,  fin:mid1,ini2:mid2,fin2:ci,badge:'badge-partido',color:'#ffa040',active:true,esPartido:true},
    ];
  }
}
...
function _fillEmpCont(contId){
  ...
  empleados.forEach(function(emp,idx){
    ...
    cont.innerHTML+='<div class="empleado-card" id="ec-'+emp.id+'">'
      ...
      +(contId==='empleados-list'&&emp.bdId?'<div style="margin-top:8px"><button data-bid="'+emp.bdId+'" data-nom="'+emp.nombre.replace(/"/g,'&quot;')+'" onclick="abrirVacacionesModal(parseInt(this.dataset.bid),this.dataset.nom)" style="background:none;border:1px solid #2a5090;border-radius:7px;padding:5px 12px;color:#5090d0;font-size:11px;cursor:pointer">🏖 Vacaciones</button></div>':'')
...
async function cmpAnalizarFactura(base64, mediaType){
  ...
  if(!apiKey){
    cont.innerHTML = '<div style="color:var(--red);padding:16px;text-align:center">No hay clave API configurada. Configúrala en Ajustes.</div>';
    return;
  }
      ...
      body: JSON.stringify({
        ...
        messages: [{
          ...
          content: [
            ...
            { type: 'text', text: 'Analiza esta factura y extrae los artículos en el formato JSON especificado.' }
          ]
        }],
        system: systemPrompt
      })
...
function cmpMostrarPreviaFactura(datos){
  ...
  if(!datos || !datos.articulos || !datos.articulos.length){
    cont.innerHTML = '<div style="color:var(--red);padding:16px;text-align:center">No se han podido extraer artículos de la factura.</div>';
    return;
  }
  ...
  var rowsHtml = datos.articulos.map(function(a, i){
    ...
    var esOtra = !unidadMatch;
    var unidadOpts = _ULIST.map(function(u){
      return '<option value="'+u+'"'+(u===unidadMatch?' selected':'')+'>'+u+'</option>';
    }).join('') + '<option value="__OTRA__"'+(esOtra?' selected':'')+'>OTRA...</option>';
    var unidadCell =
      '<select id="fac-unidad-'+i+'" data-idx="'+i+'" style="font-size:11px;padding:3px 4px;border:1px solid var(--border);border-radius:6px;background:var(--card);color:var(--text)" onchange="var t=document.getElementById(\'fac-unidad-text-\'+this.dataset.idx);if(t)t.style.display=this.value===\'__OTRA__\'?\'inline-block\':\'none\'">'+unidadOpts+'</select>'
      +'<input id="fac-unidad-text-'+i+'" type="text" placeholder="unidad" value="'+(esOtra?unidadRaw:'')+'" style="width:48px;font-size:11px;padding:3px 4px;border:1px solid var(--border);border-radius:5px;background:var(--card);color:var(--text);margin-left:4px;display:'+(esOtra?'inline-block':'none')+'">';
    return '<tr style="border-top:1px solid var(--border)">'
      ...
      +'<td style="padding:6px 4px;white-space:nowrap">'+unidadCell+'</td>'
...
async function cmpAceptarFactura(datosArg, provNombreArg){
  ...
  var seleccionados = articulosDatos.reduce(function(acc, a, i){
    ...
    if(cb ? cb.checked : true){
      ...
      var unidadSel    = document.getElementById('fac-unidad-'+i);
      var unidadTxtInp = document.getElementById('fac-unidad-text-'+i);
      var _u;
      if(unidadSel){
        _u = unidadSel.value === '__OTRA__'
          ? (unidadTxtInp ? (unidadTxtInp.value.trim() || 'ud') : 'ud')
          : (unidadSel.value || 'ud');
      } else {
        _u = a.unidad || 'ud';
      }
...
function invCocinaMostrarFamilia(famEnc){
  ...
  var s18 = 'width:60px;background:var(--darker);border:1px solid var(--border);border-radius:6px;padding:4px 6px;color:var(--text);font-size:13px;outline:none;text-align:right';
  var rowsHtml = arts.map(function(a){
    var sMin = a.stock_minimo != null ? parseFloat(a.stock_minimo) : null;
    var sMinStr = sMin !== null ? sMin : 'null';
    return '<div style="display:flex;align-items:center;gap:10px;padding:10px 0;border-bottom:1px solid var(--border)">'
      ...
      +'<input type="number" min="0" step="1" placeholder="0" id="inv18-ent-'+a.id+'" onchange="inv18CheckDual('+a.id+','+sMinStr+')" style="'+s18+'"></div>'
      +'<div style="display:flex;align-items:center;gap:4px"><span style="font-size:10px;color:var(--muted)">Suelto</span>'
      +'<input type="number" min="0" step="0.5" placeholder="0" id="inv18-fra-'+a.id+'" onchange="inv18CheckDual('+a.id+','+sMinStr+')" style="'+s18+'">'
...
function inv18CheckDual(artId, sMin){
  var entInput = document.getElementById('inv18-ent-'+artId);
  var fraInput = document.getElementById('inv18-fra-'+artId);
  var flag     = document.getElementById('inv18-flag-'+artId);
  if(!flag) return;
  var empty = (!entInput||entInput.value==='') && (!fraInput||fraInput.value==='');
  if(empty){ flag.textContent=''; return; }
  var total = (parseInt((entInput&&entInput.value)||0)||0) + (parseFloat((fraInput&&fraInput.value)||0)||0);
  var bajo = sMin !== null && total <= sMin;
  flag.textContent = bajo ? '🔴' : '🟢';
  if(entInput) entInput.style.borderColor = bajo ? 'var(--red)' : 'var(--border)';
  if(fraInput) fraInput.style.borderColor = bajo ? 'var(--red)' : 'var(--border)';
}
...
async function inv18Guardar(){
  ...
  var promesas = [];
  arts.forEach(function(a){
    var entInput = document.getElementById('inv18-ent-'+a.id);
    var fraInput = document.getElementById('inv18-fra-'+a.id);
    var hasValue = (entInput && entInput.value !== '') || (fraInput && fraInput.value !== '');
    if(hasValue){
      var val = (parseInt((entInput&&entInput.value)||0)||0) + (parseFloat((fraInput&&fraInput.value)||0)||0);
      var sMin = a.stock_minimo != null ? parseFloat(a.stock_minimo) : null;
  ...
  if(bajosDeMinimo.length){
    ...
    var lineas = bajosDeMinimo.map(function(x){ return '- '+x.nombre+': '+x.actual+' '+x.unidad+' (minimo '+x.minimo+' '+x.unidad+' en camara)'; }).join('\n');
    var msg = 'STOCK BAJO - Inventario Cocina '+fecha+'\n\n'+lineas+'\n\nPor favor reponer antes del proximo servicio.';
...
function invCocinaFiltrar(){
  ...
  var s18f = 'width:60px;background:var(--darker);border:1px solid var(--border);border-radius:6px;padding:4px 6px;color:var(--text);font-size:13px;outline:none;text-align:right';
  var rowsHtml = arts.map(function(a){
    var sMin = a.stock_minimo != null ? parseFloat(a.stock_minimo) : null;
    var sMinStr = sMin !== null ? sMin : 'null';
    return '<div style="display:flex;align-items:center;gap:10px;padding:10px 0;border-bottom:1px solid var(--border)">'
      ...
      +'<div style="display:flex;flex-direction:column;gap:3px;align-items:flex-end">'
      +'<div style="display:flex;align-items:center;gap:4px"><span style="font-size:10px;color:var(--muted)">Und. enteras</span>'
      +'<input type="number" min="0" step="1" placeholder="0" id="inv18-ent-'+a.id+'" onchange="inv18CheckDual('+a.id+','+sMinStr+')" style="'+s18f+'"></div>'
      +'<div style="display:flex;align-items:center;gap:4px"><span style="font-size:10px;color:var(--muted)">Suelto</span>'
      +'<input type="number" min="0" step="0.5" placeholder="0" id="inv18-fra-'+a.id+'" onchange="inv18CheckDual('+a.id+','+sMinStr+')" style="'+s18f+'">'
      +'<span style="font-size:11px;color:var(--muted);min-width:28px">'+(a.unidad||'')+'</span></div>'
      +'</div>'
      +'<span style="width:20px;text-align:center;font-size:14px" id="inv18-flag-'+a.id+'"></span>'
      +'</div>';
...
async function clGuardarInventarioCierre(tareaIdx){
  ...
  if(bajosDeMinimo.length){
    ...
    var lineas = bajosDeMinimo.map(function(x){
      return '- '+x.nombre+': '+x.actual+' '+x.unidad+' (minimo '+x.minimo+' '+x.unidad+' en camara)';
    }).join('\n');
    var msg = 'STOCK BAJO - Inventario Cocina '+fecha+'\n\n'+lineas+'\n\nPor favor reponer antes del proximo servicio.';
    sbGet('empleados','nombre=eq.DOMINGO&local_id=eq.1&select=telefono').then(function(rows){
      var domingo = rows && rows[0] && rows[0].telefono ? rows[0].telefono.replace(/\s+/g,'') : '';
...
function winvCheckDual(artId, sMin){
  var entInput = document.getElementById('winv-ent-'+artId);
  var fraInput = document.getElementById('winv-fra-'+artId);
...
function _winvRowHtml(a){
  var sMin    = a.stock_minimo != null ? parseFloat(a.stock_minimo) : null;
  var sMinStr = sMin !== null ? sMin : 'null';
  var s = 'width:60px;background:var(--darker);border:1px solid var(--border);border-radius:6px;padding:4px 6px;color:var(--text);font-size:13px;outline:none;text-align:right';
  var inputHtml =
    '<div style="display:flex;flex-direction:column;gap:3px;align-items:flex-end">'
    +'<div style="display:flex;align-items:center;gap:4px"><span style="font-size:10px;color:var(--muted)">Und. enteras</span>'
...
function winvMostrarFamilia(el, famEnc){
  ...
  var rowsHtml = arts.map(_winvRowHtml).join('');
  ...
  grid.innerHTML =
    ...
    +'</div>'
    +'<div style="font-size:11px;color:var(--muted);margin-bottom:8px">🔴 artículo bajo de stock</div>'
    +rowsHtml
...
async function winvGuardarArts(arts){
  ...
  arts.forEach(function(a){
    var entInput = document.getElementById('winv-ent-'+a.id);
    var fraInput = document.getElementById('winv-fra-'+a.id);
    var hasValue = (entInput && entInput.value !== '') || (fraInput && fraInput.value !== '');
    var val = (parseInt((entInput&&entInput.value)||0)||0) + (parseFloat((fraInput&&fraInput.value)||0)||0);
    if(hasValue && !isNaN(val)){
      winvStockData[a.id] = { val: val, nombre: a.nombre, unidad: a.unidad||'', stock_minimo: a.stock_minimo };
      guardados++;
    }
  });
